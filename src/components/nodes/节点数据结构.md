...
设计思路：
一方面需要给vue用，一方面要给后端用
connections的data { type:"FromInner", path: ["payloads", "idxxx-pr"], useid: ["使用节点id"] }
主要用来指示去哪里找数据

payloads和results的data { label: "内容", type: "String", key:"text", data: "", uitype: "textcontent", hid: "", oid: "" }
