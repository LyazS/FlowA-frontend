...
```js
{
    ...
    data: {
        ...
        // 节点链接 ===================================================================
        // 变量获取机制：
        // * 如果有输入handle，则默认会从上一个节点的对应outputs里边寻找
        // * 如果输入handle有data内容，则作为内置变量提供
        // * 搜寻上一个节点的outputs时，可以根据对应的type来搜寻
        // * * 如果type是FromInner，则从上一个节点对应的payloads或results里边寻找
        // * * 如果type是FromOuter，则递归到上上个节点
